...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://672c26ca1600dda5a9f76967.mockapi.io/api/v1/Students', { studentNumber, password, ...serializedSemesters, });
        ...
        <form onSubmit={handleSubmit}>
          <div className="row g-3">
            <div className="col-sm-6">
              ...
              <input type="number" className="form-control" id="studentNumber" placeholder="학번" value={studentNumber} onChange={(e) => setStudentNumber(e.target.value)} required />
            ...
            <div className="accordion" id="semesterAccordion">
              {[1, 2, 3, 4].map((year) => (
                <div className="accordion-item mb-3" key={year}>
                  ...
                  <div id={`collapseYear${year}`} className="accordion-collapse collapse show" aria-labelledby={`headingYear${year}`} >
            ...
            <button className="w-100 btn btn-primary btn-lg" type="submit"> 가입하기 </button>
          </div>
        </form>
      </div>
    </div>
